...
class Fixedvalues
{
	...
	public function sendSMS($message,$mobilenumbers)
	{
		...
		$password="pushkar.ahuja"; //your password
		//$mobilenumbers="09820035947"; //enter Mobile numbers comma seperated
